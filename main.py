...
class main():
	...
	def update_state_estimate(self):
		...
		self.corrected_state_vector = self.state_space_model_obj.x_sub_k_minus_1  + self.optimal_kalman_gain_obj.K_sub_k @ self.measurement_rasidual_obj.predicted_y_sub_k
